...
```
wget https://raw.githubusercontent.com/clarksye/squid-proxy-installer/master/squid3-install.sh -O squid3-install.sh
...
```
wget https://raw.githubusercontent.com/clarksye/squid-proxy-installer/master/squid-conf-ip.sh
